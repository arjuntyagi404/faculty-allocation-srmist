...
FA_SUBJECTS = {
    "Semester 1": ("Programming For Problem Solving",),
    "Semester 2": ("Object Oriented Design And Programming",),
    "Semester 3": (
...
FA_SEMESTERS = tuple(FA_SUBJECTS)
...
CURRICULA = {
    "UG": (
        ("Computer Science and Business Systems", "https://webstor.srmist.edu.in/web_assets/downloads/2026/computer-science-and-business-system-curriculum-2021.pdf"),
        ("Computer Science Engineering (Data Science)", "https://webstor.srmist.edu.in/web_assets/downloads/2026/cse-data-science-curriculum-2021.pdf"),
        ("Computer Science Engineering (Big Data Analytics)", "https://webstor.srmist.edu.in/web_assets/downloads/2026/cse-with-spl-in-big-data-analytics.pdf"),
        ("Computer Science Engineering (Blockchain Technology)", "https://webstor.srmist.edu.in/web_assets/downloads/2026/cse-with-spl-in-blockchain-technology-curriculum-2021.pdf"),
        ("Computer Science Engineering (Gaming Technology)", "https://webstor.srmist.edu.in/web_assets/downloads/2026/cse-with-spl-in-gaming-technology-curriculum-2021.pdf"),
    ),
    "PG": (
        ("Integrated M.Tech CSE (Data Science)", "https://webstor.srmist.edu.in/web_assets/downloads/2026/integrated-mtech-in-cse-with-spl-in-data-science-curriculum-2021.pdf"),
    ),
}
...
def _fa_core_subjects():
    subjects_by_name = {
        info["name"]: {"code": code, "name": info["name"]}
        for code, info in SUBJECTS.items()
    }
    return {
        semester: [subjects_by_name[name] for name in names if name in subjects_by_name]
        for semester, names in FA_SUBJECTS.items()
    }

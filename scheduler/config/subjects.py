SUBJECTS = {
    "21CSC302J": {"name": "Computer Networks", "category": "core", "semester": 5, "slot": "A", "lab_slots": {"1": "P6", "2": "P1"}},
    "21CSC201J": {"name": "Data Structures and Algorithms", "category": "core", "semester": 3, "slot": "B", "lab_slots": {"1": "P8", "2": "P3"}},
    "21CSS201T": {"name": "Computer Organization and Architecture", "category": "core", "semester": 3, "slot": "C"},
    "21CSC206P": {"name": "Advanced Object Oriented Programming", "category": "lab", "semester": None, "slot": "D", "lab_slots": {"1": "P10", "2": "P5"}},
    "21CSC203P": {"name": "Advanced Programming Practice", "category": "lab", "semester": 3, "slot": "E", "lab_slots": {"1": "P7", "2": "P4"}},
    "21CSC307P": {"name": "Machine Learning for Data Analytics", "category": "lab", "semester": 5, "slot": "F", "lab_slots": {"1": "P9", "2": "P2"}},
...
REGULATIONS = ("2021", "2026", "2018")
ACTIVE_REGULATION = "2021"
PROGRAMS = ("UG", "PG")
DEPARTMENTS = ("BDA", "CSBS", "BCT", "GT", "M.Tech")


def _add_production_fields(code, info):
    """Add the production subject schema while retaining legacy keys."""
    ...
    return {
        **info,
        ...
        "category": category,
        "course_type": code[-1].upper(),
        "regulation": info.get("regulation", ACTIVE_REGULATION),
...
SUBJECTS = {
    code: _add_production_fields(code, info)
